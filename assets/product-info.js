...
// on scroll, once past scroll position .product-form__submit, add .product-form__submit--sticky
const submitButton = document.querySelector('.product-form__buttons');

window.addEventListener('scroll', () => {


  //if window width is below 1000px, don't add sticky class

  if (window.innerWidth < 1000) {

  if (window.scrollY > submitButton.offsetTop) {
    submitButton.classList.add('product-form__buttons--sticky');
  } else {
    submitButton.classList.remove('product-form__buttons--sticky');
  }
